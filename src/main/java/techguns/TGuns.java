...
public class TGuns implements ITGInitializer {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		m4 = new GenericGun("m4",ASSAULTRIFLE_MAG_PROJECTILES, false, 3, 30,45,11.0f, TGSounds.M4_FIRE, TGSounds.M4_RELOAD, MAX_RANGE_RIFLE, 0.015f).setBulletSpeed(4.0f).setZoom(0.75f, true,0.75f,false).setDamageDrop(25, 40, 7.0f).setAIStats(RANGE_MEDIUM, 30, 3, 3).setTextures("textures/guns/m4Texture", 4).setTurretPosOffset(0, 0, 0.08f)/*.setMuzzleParticle(1,0,0.025f,0)*/.setPenetration(PENETRATION_LOW).setMuzzleFlashTime(4);
